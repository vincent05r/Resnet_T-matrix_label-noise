...
Model_2 =  Resnet.ResNet18 #training choose between ResNet18 or ResNet34
...
cifar_config = {
    'path' : "./dataset/CIFAR.npz",  #the path for running CIFAR dataset
    'dataset' : 'cifar',
    'n_epoch_training' : 70,  #200/100/70
