...
for model_number in range(2):
    for dataset_number in range(1,3):
        ...
        if model_number == 0:
            version = f'RESNET34_train_{training_target_ds}_benchmark'
        else:
            version = f'RESNET18_train_{training_target_ds}_benchmark'

        training_iteration_eval = 1 #number of training loop
